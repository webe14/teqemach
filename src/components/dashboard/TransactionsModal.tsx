        ...
        <div className="p-4 sm:p-6 overflow-y-auto flex-1 space-y-4">
          ...
          {selectedReceipt ? (
            <div className="space-y-5 animate-fadeIn">
              ...
              <div className="rounded-2xl border-2 border-slate-200 bg-slate-50 p-5 space-y-4 shadow-sm relative overflow-hidden text-slate-900">
                ...
                <div className="flex items-center justify-between pb-3 border-b border-slate-200">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-500 font-medium">Payment Receipt</p>
                    </div>
                  </div>
                ...
                <div className="space-y-2.5 text-xs">
                  <div className="flex justify-between items-center py-1.5 border-b border-slate-200">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      >
                        {copiedRef === selectedReceipt.txnRef ? <Check className="w-3.5 h-3.5 text-emerald-600" /> : <Copy className="w-3.5 h-3.5" />}
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center py-1.5 border-b border-slate-200">
                    ...
                    <span className="font-bold text-slate-900">{selectedReceipt.groupName}</span>
                  </div>
                  ...
                  <div className="flex justify-between items-center py-1.5 border-b border-slate-200">
                    <span className="text-slate-600 font-semibold">Collector:</span>
                    <span className="font-bold text-slate-900">{selectedReceipt.collectorName}</span>
                  </div>
              ...
              <Button
                ...
                className="w-full h-12 rounded-2xl font-bold text-xs sm:text-sm border-2 border-slate-300 bg-white hover:bg-slate-100 text-slate-800"
              >
